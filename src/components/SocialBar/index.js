...
export default function SocialBar() {
  return (
    ...
    <a className="mx-3" target="_blank" rel="noopener noreferrer" href="https://twitter.com/snowy2007"><TiSocialTwitter className="w-8 h-8  text-snowmeister-400 currentColor" /></a>
    <a className="mx-3" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/mark-kennard-0480592b/"><TiSocialLinkedin className="w-8 h-8  text-snowmeister-400 currentColor" /></a>
    <a className="mx-3" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/snowyandpixel/"><TiSocialInstagram className="w-8 h-8  text-snowmeister-400 currentColor" /></a>
    <a className="mx-3" target="_blank" rel="noopener noreferrer" href="https://github.com/snowmeister"><TiSocialGithub className="w-8 h-8  text-snowmeister-400 currentColor" /></a>
    ...
    <a className="mx-3" target="_blank" rel="noopener noreferrer" href="https://codepen.io/snowmeister"><DiCodepen className="w-8 h-8  text-snowmeister-400 currentColor" /></a>
