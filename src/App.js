    ...
    <div id="app" className="font-nunito max-w-4xl flex items-center h-auto h-screen flex-wrap mx-auto my-12 leading-7 ">
      <div className="w-full mt-32 mx-8  ">
        <div className="rounded-lg  p-4 md:p-12 text-center bg-gradient-to-t via-snowmeister-100 via-snowmeister-100 from-transparent shadow-xl">
          ...
          <div class="mx-auto  w-3/5 pt-3 border-b-2 border-snowmeister-200 opacity-75"></div>
          <p className="pt-4 text-base font-bold flex items-center justify-center text-snowmeister-400 text-shadow-white">
          <ImProfile className="h-4 w-4 fill-current opacity-80 text-snowmeister-400 pr-4" />
            Software Engineer / Foodie / Conure Sidekick</p>
            
          <p className="pt-2 text-snowmeister-400 text-xs lg:text-sm flex items-center justify-center  text-center"><svg className="h-4 fill-current text-snowmeister-400 text-shadow-white pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <div className="pt-4 text-left mx-8 text-snowmeister-400 font-light " >
            <p className="pt-4 text-left text-xl leading-8 "><strong className="font-bold">Hello! </strong> I'm Mark, also known as Snowmeister. I'm a full-stack software engineer with over 25 yrs experience across a wide range of industries, from recruitment, streaming media and online gaming to travel, digital signage and most recently cyber-security. </p>
